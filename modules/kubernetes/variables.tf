...
#   type        = string
#   default     = ""
#   description = "Уазываем в тех случаях , когда кластер куба создается в одном folder, а subnets принадлежат другому folder"
# }

# variable "custom_service_accounts_enabled" {
#   type    = bool
#   default = false
# }
